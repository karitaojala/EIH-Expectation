function P = VASScale_vX(P,O,varargin)
...
% VASScale_v4([],P.display.wHandle,P.display.rect,P.presentation.sPlateauMaxRating,scaleInitVAS,P.style.backgr,P.style.startY,P.keys,'Pain',1,P.language);
    ...
    while numberOfSecondsRemaining  > 0
        ...
        if strcmpi(scaleType,'single') % regular 0-100 VAS
            ...
            Screen('DrawText',window,anchorStrings{1},axesRect(1)-textWidths(1)/2,yCenter+25,scaleColor);
            Screen('DrawText',window,anchorStrings{2},axesRect(1)-textWidths(2)/2,yCenter+25+textSize,scaleColor);
            Screen('DrawText',window,anchorStrings{3},axesRect(3)-textWidths(3)/2,yCenter+25,scaleColor);
            Screen('DrawText',window,anchorStrings{4},axesRect(3)-textWidths(4)/2,yCenter+25+textSize,scaleColor);    
        ...
        elseif strcmpi(scaleType,'double') % 0-49/50-100 VAS (includes middle anchor)
            ...
            Screen('DrawText',window,anchorStrings{1},axesRect(1)-textWidths(1)/2,yCenter+25,scaleColor);
            Screen('DrawText',window,anchorStrings{2},axesRect(1)-textWidths(2)/2,yCenter+25+textSize,scaleColor);
            Screen('DrawText',window,anchorStrings{3},xCenter-textWidths(3)/2,yCenter+25,scaleColor);
            Screen('DrawText',window,anchorStrings{4},xCenter-textWidths(4)/2,yCenter+25+textSize,scaleColor);            
            Screen('DrawText',window,anchorStrings{5},axesRect(3)-textWidths(5)/2,yCenter+25,scaleColor);
            Screen('DrawText',window,anchorStrings{6},axesRect(3)-textWidths(6)/2,yCenter+25+textSize,scaleColor);            
        ...
        elseif strcmpi(scaleType,'Test')
            ...
            stringArray={ 'left', 'anchor', 'central', 'anchor', 'right' 'anchor' };
